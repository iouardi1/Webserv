...
alias_directive(std::string()), autoindex_directive(std::string()), limit_except_directive(std::vector<std::string>()) {}
...
void	ft::location::setter(std::string dir, std::string value, std::vector<std::string> v)
{
	...
	std::string arr1[3] = {"root", "alias", "autoindex"};
	std::string arr2[3] = {"index", "limit_except", "return"};
	void (ft::location::*f1[3])(std::string) = {&ft::location::set_root, &ft::location::set_alias, &ft::location::set_autoindex};
